Feature: PROD_TC7_ID_NYstateTaxCredit_Validation
...
Scenario: PROD_ID_NYstateTaxCredit_Validation
...
Then User enters his/her Residential First Name as "RegManualTest" and Last Name as "NYstateTaxCred"
