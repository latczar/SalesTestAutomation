Feature: PROD_TC3_SPD_GrossPrice_Validation
...
Then User enters his/her Residential First Name as "RegManualTestA" and Last Name as "LGrossPriceValidationregspd"
...
Then User enters "50000" in the Gross Price tab for Lease option
Then User unticks the show Cash option
Then clicks on save changes for the Quote Settings modal
Then User clicks on the Save Design button
