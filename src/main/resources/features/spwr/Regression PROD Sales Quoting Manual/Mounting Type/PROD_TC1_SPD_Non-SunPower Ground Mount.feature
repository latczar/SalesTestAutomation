Feature: PROD_TC1_SPD_Non-SunPower Ground Mount
...
Scenario: PROD_SPD_Non-SunPower_Ground_Mount
...
Then User enters his/her Residential First Name as "RegManualTestA" and Last Name as "NonspwrGroundMount"
...
#Then User will verify that the system is able to lock a quote with the Mounting type set to Non-SunPower Ground Mount using any FO