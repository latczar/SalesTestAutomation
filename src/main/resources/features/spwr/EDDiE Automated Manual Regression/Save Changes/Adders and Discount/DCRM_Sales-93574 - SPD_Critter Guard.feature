Feature: DCRM_Sales-93574 - SPD_Critter Guard
...
Then User enters his/her Residential First Name as "Regautotest" and Last Name as "CritterGuard"
...
#Then User will verify that the system is able to lock a quote with the Critter guard accessory added