...
Then User enters his/her Residential First Name as "PenfedRefi" and Last Name as "QAidtest13"
...
Then User ends the test scenarioFeature: ID Loan_UAT_QuoteCreationE2E