Feature: 006_Loan_HI_withoutCoPayment
...
Scenario: 006_Loan_HI_withoutCoPayment
...
Then User enters his/her Residential First Name as "ManualTest" and Last Name as "HINoCopayment06"
