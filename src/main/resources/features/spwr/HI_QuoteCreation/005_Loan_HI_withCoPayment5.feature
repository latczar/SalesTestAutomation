Feature: 005_Loan_HI_withCoPayment
...
Scenario: 005_Loan_HI_withCoPayment
...
Then User enters his/her Residential First Name as "ManualTest" and Last Name as "HIwithCopayment10"
