Feature: 002_Loan_HI_withCoPayment
...
Scenario: 002_Loan_HI_withCoPayment
...
Then User enters his/her Residential First Name as "ManualTest" and Last Name as "HIwithCopayment07"
...
Then User will add a CoPayment input as "2000"
