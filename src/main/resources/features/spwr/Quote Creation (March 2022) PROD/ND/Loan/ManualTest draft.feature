...
Then User enters his/her Residential First Name as "ManualTest" and Last Name as "draft06"
...
Then User enters "500" in the Storage Dealer Commission tab for Loan option
