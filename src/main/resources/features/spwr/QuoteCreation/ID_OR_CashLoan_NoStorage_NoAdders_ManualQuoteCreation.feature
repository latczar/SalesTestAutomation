Feature: ID_OR_CashLoan_NoStorage_NoAdders_ManualQuoteCreation
...
Scenario: ID OR Cash Loan No Storage No Adders
...
Then User enters Residential address as "5690 SW Bluff Ln, Culver, OR 97734"
