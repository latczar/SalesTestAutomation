Feature: Cash_NoStorage_NoAdders_ManualQuoteCreationOnly
...
Scenario: Cash_NoStorage_NoAdders_ManualQuoteCreation
...
Then User enters his/her Residential First Name as "ManualTestA" and Last Name as "L0611t02docgspd"
