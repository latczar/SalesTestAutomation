Feature: TPS_QA_CashQuoteCreation
...
Scenario: TPS_QA_CashQuoteCreation
...
Then User enters his/her Residential First Name as "RegManualTestA" and Last Name as "LCashQuoteCreation"
